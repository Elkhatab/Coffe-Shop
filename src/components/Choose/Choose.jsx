      ...
      <div className="choose__grid container grid">
        <div className="choose__content">
          <h2 className="section__title" data-title="Why Choose Us">
            Khamr El Sale7en Most Out Of Your Favorite & Tasty Coffee House You
          </h2>
          <p className="choose__description">
            There are many variations of passages of orem psum available but the{" "}
            majority have suffered alteration in some form by injected humour or{" "}
            randomised words which don't look even slighlty believable{" "}
          </p>
            ...
            <div className="choose__details-item">
              ...
              <div>
                ...
                <p className="choose__details-description">
                  There are many variations of passages of orem psum available
